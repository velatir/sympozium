...
## [0.8.13](https://github.com/velatir/sympozium/compare/v0.10.43...v0.8.13) (2026-07-23)
...
* add Cypress UX tests for instance creation and persona packs ([2ffb502](https://github.com/velatir/sympozium/commit/2ffb5026b82b116ab027c09bed58be9b9a02e8f1))
* add Cypress UX tests for instance creation and persona packs ([55e5590](https://github.com/velatir/sympozium/commit/55e5590af21dbea24e594ec7437052cc89ded4dc))
...
* add tool-call circuit breaker and configurable run timeout ([b5a3b94](https://github.com/velatir/sympozium/commit/b5a3b94cefeb6c7cf68a1c6f90181a2f45f28344))
...
* expose run timeout in web UI and CLI TUI ([3bca472](https://github.com/velatir/sympozium/commit/3bca472642dcf85df6a4f6d0f242f2ed08e3553e))
...
* lifecycle hooks — preRun and postRun containers for agent runs ([a29a8c9](https://github.com/velatir/sympozium/commit/a29a8c99a67287f063f2b1398b9e499b57e51d35))
...
* reworked memory implementation ([81fdd0c](https://github.com/velatir/sympozium/commit/81fdd0c83725dc068bc869f01b5d1af5c421c282))
...
* add metrics.k8s.io RBAC to config/rbac/role.yaml for sympozium install ([0c1a51c](https://github.com/velatir/sympozium/commit/0c1a51c8d11354aa5e2df694e8557c120b474857))
...
* add missing observability-mcp-team persona pack to Helm chart ([fc0105c](https://github.com/velatir/sympozium/commit/fc0105c0d243bb0adc58680e29a4827b7aad88bd))
...
* auto-store task/response in memory server after each agent run ([8f475fb](https://github.com/velatir/sympozium/commit/8f475fbc2bf600ca7fad12394e7c417dd63e2509))
...
* create namespace before Helm config init to fix fresh installs ([e49fa50](https://github.com/velatir/sympozium/commit/e49fa50f26604688a1dcbba6a3d06543b0442ea8))
...
* fail AgentRun when skill RBAC creation fails instead of silently continuing ([99ddb4d](https://github.com/velatir/sympozium/commit/99ddb4d698bedd758c7d5512e6da354dad5db754))
...
* guard stale Job-not-found reconcile during postRun transition ([8d2ff41](https://github.com/velatir/sympozium/commit/8d2ff41972acb551a9aabc13cc02c1807ca50560))
...
* publish TopicAgentRunFailed from controller so web proxy unblocks on failure ([b98841f](https://github.com/velatir/sympozium/commit/b98841fe441a3c3f478640963c270fd7ed31dd85))
...
* remove conflicting namespace pre-creation in helm install ([9930ba4](https://github.com/velatir/sympozium/commit/9930ba4497989fa40d2461e9bef7039586c67aa0))
...
* remove explicit host from node-probe targets to restore auto-detection ([f91229a](https://github.com/velatir/sympozium/commit/f91229afa5ba5ad0674ba6c9b202932b2a869f3f))
...
* resolve integration test hang and flaky secret-not-found error ([2fb431f](https://github.com/velatir/sympozium/commit/2fb431f99b42e14f6f123dbf6f62229ea3a06db0))
* resolve remaining TypeScript index signature errors in yaml-panel ([8cea011](https://github.com/velatir/sympozium/commit/8cea0119064536a30ba8a1a15d119af73c9380a9))
...
* resolve TypeScript index signature errors in yaml-panel ([4a576a1](https://github.com/velatir/sympozium/commit/4a576a1b8db3f77c7ee6cb610b08f212b3ab9cd0))
...
* run only smoke tests in CI integration workflow ([bf1c293](https://github.com/velatir/sympozium/commit/bf1c293374c6a90fa842f704d99efbad45783fdd))
...
* stop Helm template from overriding node-probe host auto-detection ([4f0e5f4](https://github.com/velatir/sympozium/commit/4f0e5f41217d5ec9bf165dda7796be0df3fd307d))
* strip directory prefix from CRD names when writing to temp dir ([1906327](https://github.com/velatir/sympozium/commit/1906327b3abd32dc887f5a09c98eada9e0fb09b6))
...
* use sentinel value for run timeout Select to avoid Radix crash ([1553b75](https://github.com/velatir/sympozium/commit/1553b75912c1ed4037bd622de09abeaed57f290d))
...
* release 0.8.13 ([8a6fa7b](https://github.com/velatir/sympozium/commit/8a6fa7b870da36f0df6ab0bcccaeda6b1f04fec4))
