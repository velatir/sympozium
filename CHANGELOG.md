...
## [0.11.0](https://github.com/velatir/sympozium/compare/v0.10.47...v0.11.0) (2026-08-21)
...
* add automated demo walkthrough recording for README GIF ([0945630](https://github.com/velatir/sympozium/commit/09456301cb845e8720abb64ce59b833fa87ea181))
* add Concepts modal explaining Sympozium ontology ([9d4bef3](https://github.com/velatir/sympozium/commit/9d4bef347b1b27b6c3446b254117c581b9c85f11))
* add edit capability for schedule cron expressions ([7abd745](https://github.com/velatir/sympozium/commit/7abd745af1cd9f2cd51f7854020f47baf294dc81))
* add edit capability for schedule cron expressions ([8f5c0b4](https://github.com/velatir/sympozium/commit/8f5c0b4e3e37288e446c055d34c43b3683f63f72)), closes [#110](https://github.com/velatir/sympozium/issues/110)
* add ensemble delete button + auto-derive permeability from relationships ([93a8ec1](https://github.com/velatir/sympozium/commit/93a8ec1c3496742275365ee2f410de7ac488e08a))
* add envtest-based system tests for API server + controllers ([2344132](https://github.com/velatir/sympozium/commit/2344132a7483162e66fb6f5deea341ff8e39d017))
* add llama-server as a first-class AI provider ([86ec4ae](https://github.com/velatir/sympozium/commit/86ec4ae6b202488ff5adfd012b9c790557d1a097))
* add llmfit DaemonSet for continuous cluster hardware fitness telemetry ([#186](https://github.com/velatir/sympozium/issues/186)) ([ec896fa](https://github.com/velatir/sympozium/commit/ec896fa37c5ba42f184e08e71e22224df9aaf59d))
* add Local Model as provider option in ensemble builder ([83f032a](https://github.com/velatir/sympozium/commit/83f032acada1e360dc57538d7a662b8c70e37c9d))
* add node probe discovery to ensemble builder provider setup ([0576c7e](https://github.com/velatir/sympozium/commit/0576c7e44191d39e15c2ea7f5ef92a525d80724a))
* add persona relationships schema and workflow canvas ([ace2bcf](https://github.com/velatir/sympozium/commit/ace2bcf788612c25e28d0e3e8c582f973d80c90f))
* Add Provider button on builder and detail workflow canvases ([a962f69](https://github.com/velatir/sympozium/commit/a962f69df181244fe9a6b8f71e3317c68c894a7e))
* add provider icons to wizard dropdown and llama-server docs ([25fca6d](https://github.com/velatir/sympozium/commit/25fca6dfddf43c18725d6e8ef4f0fa963c097ed3))
* add research-team PersonaPack with relationships and Cypress tests ([9357e0a](https://github.com/velatir/sympozium/commit/9357e0a2ec3fd0ac354ccc80da5c7c3a79db9d43))
* add Settings page with Agent Sandbox CRD install/uninstall, MCP server auth & defaults ([833bbdc](https://github.com/velatir/sympozium/commit/833bbdce455457252b7ffc7abf879b74a98a13cd))
* add shared workflow memory for cross-persona knowledge sharing ([3a163dc](https://github.com/velatir/sympozium/commit/3a163dc5656e9cce1fa8cf5b2cd775e4f91f33a9))
* Add skipped as AgentRun status - reachable via IPC similar to dry runs ([#228](https://github.com/velatir/sympozium/issues/228)) ([056421c](https://github.com/velatir/sympozium/commit/056421c6f1c7a0ad445ea3c2628da332103c12fa))
* add Stimulus node type for auto-triggered workflow prompts ([59fc3be](https://github.com/velatir/sympozium/commit/59fc3be965733570e91da4e6aa2b3fb06ccf7fd3))
* add structured health check matrix to canary UI ([73d54c1](https://github.com/velatir/sympozium/commit/73d54c1ab07d5d74af2a9ecd0ef68ad28af5df74))
* add subagent ensemble examples to install defaults ([ddb8b0d](https://github.com/velatir/sympozium/commit/ddb8b0d3f2eb525fd4bbf75b1690fcbffb41d7cf))
* add subagents skill for ad-hoc sub-agent spawning ([#171](https://github.com/velatir/sympozium/issues/171)) ([2929a80](https://github.com/velatir/sympozium/commit/2929a80ea9ccb79dde3cc8d8df03f03b4f105937))
* add Suspended field to MCPServer to prevent crash-looping defaults ([#195](https://github.com/velatir/sympozium/issues/195)) ([6200f97](https://github.com/velatir/sympozium/commit/6200f9737bbeef0487f0b3ca7e5bfb902d4b8fa3))
* add synthetic membrane layer for shared workflow memory ([5a30192](https://github.com/velatir/sympozium/commit/5a3019269a3ee9f7e73e5eab6cc30755b52f552d))
* add System Canary — built-in synthetic health testing ensemble ([fef2742](https://github.com/velatir/sympozium/commit/fef27420c9bff4c4492c14c0df4b71cdf1fdb904))
* add topology page to demo walkthrough recording ([ae6d8fc](https://github.com/velatir/sympozium/commit/ae6d8fc88d4ecdfa81dafc2f044fbdb2a99135f0))
* add workflow relationships to developer-team ensemble ([49d8e85](https://github.com/velatir/sympozium/commit/49d8e851d14583d40ed8e8f7f42c77869cd0f4ad))
* add workflows to all default ensembles ([6ad01b9](https://github.com/velatir/sympozium/commit/6ad01b9be9a4c7a23658c120a47269073bdf0ad5))
* add YAML export button to ensemble detail page ([f970d44](https://github.com/velatir/sympozium/commit/f970d448476a159a2d6d076eff42cafeb6f43dd7))
* agent edit redirect ([#320](https://github.com/velatir/sympozium/issues/320)) ([c270aaf](https://github.com/velatir/sympozium/commit/c270aafc4ce120e3f558a1d3f1c2ac1ccf700554))
* **agent-runner:** add opt-in detailed JSONL file logging with per-run directories ([#238](https://github.com/velatir/sympozium/issues/238)) ([6d52537](https://github.com/velatir/sympozium/commit/6d52537bcad973f0af37e0fa8afaceecaa910492))
* **agent-runner:** log LLM round progress during agent runs ([#225](https://github.com/velatir/sympozium/issues/225)) ([c222b8e](https://github.com/velatir/sympozium/commit/c222b8e664f42a69cad765b46e7e24a30f7df2a6))
* **agent-runner:** structured output support for Anthropic models ([6d15b73](https://github.com/velatir/sympozium/commit/6d15b738e8798cc3e9e13669dc2a7e6ac6029274))
* AgentRun dollar cost estimation with simulated pricing overlay ([798aa3f](https://github.com/velatir/sympozium/commit/798aa3f36c1d211b94858931580e0768ba21b738))
* AgentRun dollar cost estimation with simulated pricing overlay ([dfe8fdf](https://github.com/velatir/sympozium/commit/dfe8fdfcf4cac3418cca117eb4c8469a0c9550df))
* **apiserver:** accept polymorphic task in CreateRun API ([8bd38d9](https://github.com/velatir/sympozium/commit/8bd38d9357d1875ceb604bf956e7c6283ae876da))
* **apiserver:** accept polymorphic task in CreateRun API ([8460b23](https://github.com/velatir/sympozium/commit/8460b231e8ed2e45ebdcf1dfa74fdaa8ef716a17))
* **apiserver:** reload SYMPOZIUM_UI_TOKEN from a mounted file ([#25](https://github.com/velatir/sympozium/issues/25)) ([a81ed81](https://github.com/velatir/sympozium/commit/a81ed818f45832b4cdfe56a34a8e2d689f4e0ecb))
* **apiserver:** reload SYMPOZIUM_UI_TOKEN from a mounted file ([#315](https://github.com/velatir/sympozium/issues/315)) ([28cb1b7](https://github.com/velatir/sympozium/commit/28cb1b7c52acfff50532a0aa002d46b302104681))
* auto node placement via llmfit, namespace-aware models, and ModelPolicy groundwork ([2c13faf](https://github.com/velatir/sympozium/commit/2c13faf67c0139e6bd44b839cc736b4af8245c07))
* auto-detect node probe providers and allow changing ensemble provider ([e79310f](https://github.com/velatir/sympozium/commit/e79310f0950c9d2e740f37dddc70b4ba2f36f8fb))
* auto-inject delegation/supervision context from ensemble relationships ([e38e93e](https://github.com/velatir/sympozium/commit/e38e93ef6f930baf3149c4765a14644a1307154f))
* AwaitingDelegate phase, Cypress workflow tests, hooks fix ([8fee27b](https://github.com/velatir/sympozium/commit/8fee27b9645729c6990d3471dd2240224f26c6c2))
* Celln hermetic-action backend for AgentRun ([da364c4](https://github.com/velatir/sympozium/commit/da364c4c303f6b0a474934c2b322bbc99923fb87))
* Celln hermetic-action backend for AgentRun ([abea691](https://github.com/velatir/sympozium/commit/abea6914b3d410409d7752a1b5ef877e662adf19))
* channel pod CSI compatibility and dedicated service account ([1aa9a99](https://github.com/velatir/sympozium/commit/1aa9a992d6ca92ec2317c7d30dc2ea12ec27dafc))
* **channels:** wire per-agent display name for Slack sender attribution ([#263](https://github.com/velatir/sympozium/issues/263)) ([1f52056](https://github.com/velatir/sympozium/commit/1f5205692e7e79eca88ace59d2e4300f66e0b971))
* compact old tool results ([#316](https://github.com/velatir/sympozium/issues/316)) ([460798d](https://github.com/velatir/sympozium/commit/460798d947938293e7fbfc5ce493c9680bcef8d2))
* **controller:** opt-in controller-side delegation executor ([#236](https://github.com/velatir/sympozium/issues/236)) ([8e7dfd2](https://github.com/velatir/sympozium/commit/8e7dfd2dd613dbb2b11d5ccdfcc311065c1f61c3))
* **controller:** opt-in controller-side delegation executor with guardrails + telemetry ([0179b44](https://github.com/velatir/sympozium/commit/0179b4420465c44809f39fc1bb3e52c9c6334162))
* **crd:** gate ensemble auto-start with stimulus.trigger and schedule.firstTick ([b5ea9d3](https://github.com/velatir/sympozium/commit/b5ea9d33cf614a4cd034c26e88e20653ca08c7cd))
* **crd:** polymorphic task on Ensemble and SympoziumSchedule ([#26](https://github.com/velatir/sympozium/issues/26)) ([66f0c50](https://github.com/velatir/sympozium/commit/66f0c506d646febdf4def06d614d8ee1f3bfcdd9))
* **cypress:** parameterize test model via CYPRESS_TEST_MODEL env var ([b4f68ea](https://github.com/velatir/sympozium/commit/b4f68ea8dd5ba0ad6eef18476d5630d4d0c486dc))
* **cypress:** parameterize test model via CYPRESS_TEST_MODEL env var ([af6310b](https://github.com/velatir/sympozium/commit/af6310b0f3ebfe6d361e75b6242bed6572546e53))
* declarative local model inference via Model CRD ([1a6da42](https://github.com/velatir/sympozium/commit/1a6da42cb691fa0f4569e3fe8cb450f5408f4494))
* declarative local model inference via Model CRD ([4095ea8](https://github.com/velatir/sympozium/commit/4095ea88ef85f3f32f2a4b7bb809907f648c04a8))
* delegate_to_persona tool and dashboard team canvas widget ([5b25b59](https://github.com/velatir/sympozium/commit/5b25b596c956ea3896d14a5d8d64d81177b0db6b))
* deploy celln installer + router via Helm ([bda32eb](https://github.com/velatir/sympozium/commit/bda32ebed47a35ab9df1ab3cc56b2e47f0084d2b))
* enable Celln backend by default in Helm chart ([e92e58a](https://github.com/velatir/sympozium/commit/e92e58a14ca0f58554d2e4e9296a15858a0d287a))
* enforce ExposeTags and MaxTokensPerRun membrane fields ([b6aa66c](https://github.com/velatir/sympozium/commit/b6aa66c1b2054169fbe5608163ae5aa50b68b078))
* envtest-based system tests + Cypress fixes ([e173d95](https://github.com/velatir/sympozium/commit/e173d95afc89f193ccab21eaed7ed2b638d10022))
* evidence traces for shared memory + memory browser UI ([#219](https://github.com/velatir/sympozium/issues/219)) ([9ec7ccc](https://github.com/velatir/sympozium/commit/9ec7ccc68b1480c3370934fecaf7a56a94b0292a))
* expand default MCP server catalog ([ab27fac](https://github.com/velatir/sympozium/commit/ab27fac64b0b1ebdc6072de351c511439d8869a8))
* expand default MCP server catalog with grafana, kubernetes, argocd, and postgres ([b620dbf](https://github.com/velatir/sympozium/commit/b620dbfb5aed5a2767bd4d50917e4f4a19ec897f))
* fmt code ([f6f61c3](https://github.com/velatir/sympozium/commit/f6f61c39e008fc489b2a5ad27ed1bb86295cc8f3))
* fmt code ([fee9454](https://github.com/velatir/sympozium/commit/fee9454e5cf31cd8e4b8e7e067ba8271bb4ee036))
* gate Celln behind explicit opt-in, add live status banner ([2d0c2ef](https://github.com/velatir/sympozium/commit/2d0c2ef34b2b71de65c2261ba6764800b48bcca6))
* **gate:** add response gate hooks with manual approval flow ([0e5ad97](https://github.com/velatir/sympozium/commit/0e5ad9718826a2b0b776131890a6aad9dcaa5a49))
* global persona canvas and live run status highlighting ([5e69827](https://github.com/velatir/sympozium/commit/5e69827d36f4e7d9c053c29631ef4071e46833a3))
* implement allow/deny tool policy semantics ([dfb12dd](https://github.com/velatir/sympozium/commit/dfb12dde8175aede5c1a45b556dcaed649444854))
* implement blocking delegation between ensemble personas ([dc2c7a6](https://github.com/velatir/sympozium/commit/dc2c7a6cba1cced245ae3390d618e2352b2fd6c7))
* implement sequential workflow trigger in controller ([c5b9e45](https://github.com/velatir/sympozium/commit/c5b9e456f78261a35043e45e672342dc3eeac0f0))
* interactive canvas editing and persona-targeted spawning ([c3af2ea](https://github.com/velatir/sympozium/commit/c3af2ea143186de52c9f99f6e499cf48a646a860))
* **makefile:** add ux-tests-serve target for running Cypress against sympozium serve ([e9c3202](https://github.com/velatir/sympozium/commit/e9c3202d98105eff3d1b7d6008b9b4f7cd7a4d2e))
* migrate Celln dispatch to /v1/executions (forge mode) ([6b8b200](https://github.com/velatir/sympozium/commit/6b8b200db97f7ee573fcc546f575aa876d84af82))
* multi-provider inference (vLLM, TGI) and cluster topology page ([c434df4](https://github.com/velatir/sympozium/commit/c434df48788878d3dee87224cde2345a3cca66a7))
* native sidecar tools declared on SkillPack CRD ([#241](https://github.com/velatir/sympozium/issues/241)) ([32a5acc](https://github.com/velatir/sympozium/commit/32a5accb1dddc7ce4850b6a3c19952bb1c3ee392))
* opt out for automatic memories ([8b74fa0](https://github.com/velatir/sympozium/commit/8b74fa0ab9115b308d4d5fc63ca4fd6bb0467f30))
* Persist AgentRun.spec.Timeout and expose runTimeout via Ensemble config ([#230](https://github.com/velatir/sympozium/issues/230)) ([897c5f0](https://github.com/velatir/sympozium/commit/897c5f0a481e116374630e4feb040e97eb8e0379))
* **placement:** claim-based model placement via bundled llmfit-dra ([07e2524](https://github.com/velatir/sympozium/commit/07e252486a543f5670dfbc80c6be2a5de4105378))
* **placement:** claim-based model placement via bundled llmfit-dra ([21532a2](https://github.com/velatir/sympozium/commit/21532a24b1bc2690a46343a6fd89027e542522c1))
* **placement:** claim-based model placement via bundled llmfit-dra ([4d70a1f](https://github.com/velatir/sympozium/commit/4d70a1faf38a8933c03250a3e991a6275c0d66b2))
* **placement:** surface pending-pod scheduler verdicts; ensure claims on the deployment path ([d4e7132](https://github.com/velatir/sympozium/commit/d4e7132f2957db27efddfd445221c794d274de8f))
* promote Team Canvas to prominent dashboard position ([958600a](https://github.com/velatir/sympozium/commit/958600a3e7cd7d3f506f62607a6e97ce466e965a))
* provider nodes on canvas + per-persona provider overrides ([4bf004a](https://github.com/velatir/sympozium/commit/4bf004aaf435c44fb7d4e44270e26898a04f56b9))
* provider nodes on dashboard canvas, fix provider-to-agent wiring ([7350791](https://github.com/velatir/sympozium/commit/73507911d4450d548e8fd8fa494ee61bc6384942))
* **providers:** add Unsloth as a supported local LLM provider ([9c246c1](https://github.com/velatir/sympozium/commit/9c246c13ba8947b4fe026836e764786b43329126))
* real-time workflow canvas updates via WebSocket ([e3fe61f](https://github.com/velatir/sympozium/commit/e3fe61f2cfa3ef2d5e6ddaf6e5e215e1399afd35))
* recover qwen-native tool_calls from reasoning_content ([f807de1](https://github.com/velatir/sympozium/commit/f807de172243672997d25c3cd311740b34396fcb))
* rename Instance→Agent, Persona→AgentConfig across entire codebase ([df230ee](https://github.com/velatir/sympozium/commit/df230eeab513085d4fd713702efd5cfefda41766))
* rename PersonaPack to Ensemble + canvas-first builder ([432355b](https://github.com/velatir/sympozium/commit/432355bca86ddf8b78d4ac6ec5be708613634bcd))
* replace LLM-based canary with deterministic health checks ([2e25fd1](https://github.com/velatir/sympozium/commit/2e25fd1a98481362ba382d4240cecf2069533d9b))
* router DaemonSet with downward API, zero IP config ([348cd3c](https://github.com/velatir/sympozium/commit/348cd3caef9dbeb4122a68703bbaaa7ba06ba4b4))
* **serve:** auto-login web UI via token in the URL fragment ([5aa40ba](https://github.com/velatir/sympozium/commit/5aa40ba8233c826f44fa9e7b8a7f102b35d51433))
* **serve:** URL auto-login; standalone agent topology nodes ([f19d0be](https://github.com/velatir/sympozium/commit/f19d0bed5e25738a1eca6994ac338114e4961d42))
* shared stimulus view/edit/retrigger dialog across all canvases ([#165](https://github.com/velatir/sympozium/issues/165)) ([196f219](https://github.com/velatir/sympozium/commit/196f219b90632b201e8d4fb765ceeb7872a65c9b))
* show local model node on ensemble workflow canvas ([13b08e5](https://github.com/velatir/sympozium/commit/13b08e5e2f28afd57f7097440d5ba01cc265957a))
* show model node on global ensemble canvas ([3f00fef](https://github.com/velatir/sympozium/commit/3f00fef205b22c188c55346f6ea07daad63f03f7))
* **sidecar-driven:** polymorphic task + TaskModeHandler registry ([#302](https://github.com/velatir/sympozium/issues/302)) ([c3038ea](https://github.com/velatir/sympozium/commit/c3038ea4065a02763059ac55c794e45e858ab9c1))
* **slack:** per-message sender attribution for multi-agent Ensembles ([#245](https://github.com/velatir/sympozium/issues/245)) ([5239b4d](https://github.com/velatir/sympozium/commit/5239b4d9945ee788ad16e01fe0c49866a73e74d8))
* sort all API list endpoints and add prompt engineering guide ([52e643e](https://github.com/velatir/sympozium/commit/52e643edcaed57d69185706fc6f4073955a5ed0a))
* stimulus node support in builder, unified canvas primitives, and UX fixes ([#162](https://github.com/velatir/sympozium/issues/162)) ([a57c8f1](https://github.com/velatir/sympozium/commit/a57c8f1c1ff7d41dcde2bb34ae0c84bf5ce79473))
* stimulus trigger gating, workstation topology demo, and buildable demo hardware ([4d39487](https://github.com/velatir/sympozium/commit/4d394873a4132fba73416ce83c5dba9805ed7e46))
* subagents skill for ad-hoc sub-agent spawning ([#175](https://github.com/velatir/sympozium/issues/175)) ([3b6e354](https://github.com/velatir/sympozium/commit/3b6e3549739079baf4d184594bb6201a88f4fd07))
* support custom headers for model provider requests ([#210](https://github.com/velatir/sympozium/issues/210)) ([8412662](https://github.com/velatir/sympozium/commit/8412662a1076b5d5a71e3626a69ab32bd95f8037))
* synthetic membrane layer for shared workflow memory ([a582317](https://github.com/velatir/sympozium/commit/a5823176a3e03bd80489ea9542c0c78b2c0b4154))
* ToolPolicy allow/deny propagation and runner-side filtering ([ebcdafe](https://github.com/velatir/sympozium/commit/ebcdafef29e18c60f60e6feade0e641eecaffbe4))
* topology dagre layout, synthetic membrane page, and UX improvements ([4cef6a2](https://github.com/velatir/sympozium/commit/4cef6a27b4cf6c01ffd89d7a9659243cf12bc94b))
* topology keyboard navigation and demo gif ([2d8b417](https://github.com/velatir/sympozium/commit/2d8b4176677ee0967ba85f527386d361cff89a02))
* **tui:** add search/filter, log improvements, status colors, and run table enhancements ([#209](https://github.com/velatir/sympozium/issues/209)) ([d70da82](https://github.com/velatir/sympozium/commit/d70da82a6c32d5acfcda666df731723f234d613d))
* **tui:** update TUI colors to neo-industrial palette ([8402a5e](https://github.com/velatir/sympozium/commit/8402a5e61f4e5e66ccb7e0e1fa995aae54100ad6))
* update TUI, topology, and ensemble canvas to industrial palette ([f7a3bc7](https://github.com/velatir/sympozium/commit/f7a3bc721d95e57728367f056c29c8f6e5b20d3e))
* **web+apiserver:** decorate topology nodes with llmfit-dra accelerator inventory ([4bcaeef](https://github.com/velatir/sympozium/commit/4bcaeef1fe1912f6c988153fb6cdb69739cef544))
* **web:** accelerator tree leaves on density nodes and topology cards ([2bebd1a](https://github.com/velatir/sympozium/commit/2bebd1aec653c18a82c01eccac01d3ec38f93734))
* **web:** add run notifications, unseen watermark, and polling ([42bb00b](https://github.com/velatir/sympozium/commit/42bb00b9cceae427a0ce3a0c2b12895b94e5e6af))
* **web:** draw demo topology nodes as workstations with accelerator bays ([129cdba](https://github.com/velatir/sympozium/commit/129cdbab774aa0423e639634a66dff40177029d0))
* **web:** improve sidebar hierarchy, breadcrumbs, and detail page UX ([0a622d1](https://github.com/velatir/sympozium/commit/0a622d176c0ee0ad536273d5eb61c277a5e778d1))
* **web:** let the ensemble builder choose the stimulus trigger mode ([bc5a8cb](https://github.com/velatir/sympozium/commit/bc5a8cbabb57b32570cd9822a4d1d60ed1012cc4))
* **web:** neo-industrial UX theme with classic toggle ([#200](https://github.com/velatir/sympozium/issues/200)) ([5af0144](https://github.com/velatir/sympozium/commit/5af0144a5543523c21f6d12d4b3941d7cd53b595))
* **web:** render standalone agents on the topology with model edges ([ba22b3e](https://github.com/velatir/sympozium/commit/ba22b3e82f48bdaf9295ad3cb7d839bdb5ab773a))
* **web:** show estimated spend inline in the conversation panel ([87f4435](https://github.com/velatir/sympozium/commit/87f443574100c82c7be090a195bac5c4df1c0fca))
* **web:** single effective spend value with totals per page and conversation ([46e6537](https://github.com/velatir/sympozium/commit/46e6537f105f3edb0c628849fd4418c46a1b549d))
* **web:** waiting reasons on topology model nodes; consolidate Models nav ([8813105](https://github.com/velatir/sympozium/commit/881310578d8b68f2a86d1f3303b35d08e83bc0a6))
* **web:** waiting reasons on topology model nodes; consolidate Models nav ([ad5e566](https://github.com/velatir/sympozium/commit/ad5e5664b65657cc981be1f34f5bfa383230d4c9))
* wire ToolPolicy.Deny to agent-runner tool filtering (VEL-1084) ([6bd88e4](https://github.com/velatir/sympozium/commit/6bd88e4ca082e725fcd9afe78f8da4241767850e))


### Bug Fixes

* add build tag to system tests so go test ./... skips them ([50052f0](https://github.com/velatir/sympozium/commit/50052f0d10ea250ec7e4984b28db97b98a00347c))
* add missing DryRun field and supporting changes omitted from dc2c7a6 ([7f0a4aa](https://github.com/velatir/sympozium/commit/7f0a4aaf9f17ee46f408a839d512c18590833098))
* add missing nodes RBAC for apiserver — restores topology and cluster status ([58ad746](https://github.com/velatir/sympozium/commit/58ad746c8fba7d1d18365ee023d5492372acacd7))
* add watch verb to apiserver secrets RBAC ([3037f65](https://github.com/velatir/sympozium/commit/3037f65768d6b03b22ff5e1329e8ebe45e902aca))
* **agent-runner:** serialize Bedrock tool schemas as JSON objects ([#259](https://github.com/velatir/sympozium/issues/259)) ([f0f22c7](https://github.com/velatir/sympozium/commit/f0f22c78a0c64e8dacc38714354632a15e8cf907)), closes [#255](https://github.com/velatir/sympozium/issues/255)
* **agent-runner:** skip empty-task seed message in prompt-server mode ([91dd228](https://github.com/velatir/sympozium/commit/91dd228ebc1e69ef8131320f2c0282da68c0447b))
* **agent-runner:** skip empty-task seed message in prompt-server mode ([fbadd2d](https://github.com/velatir/sympozium/commit/fbadd2d233585dca8c1d38cc3f45d059176822f8))
* align Ensemble update path with create path for all Agent fields ([#264](https://github.com/velatir/sympozium/issues/264)) ([e33be9f](https://github.com/velatir/sympozium/commit/e33be9f1a51e6f92410d06ecbbdf99e900b0f2bd))
* allow unauthenticated custom providers in wizard ([db1036d](https://github.com/velatir/sympozium/commit/db1036dcbf2895f737c043d94a4e4017341363b5))
* allow unauthenticated custom providers in wizard ([bccce53](https://github.com/velatir/sympozium/commit/bccce53e8a1882585d8c674ad0d72d16de023fc6))
* canary first run never triggers after duplicate-prevention change ([0bbf126](https://github.com/velatir/sympozium/commit/0bbf12614d18fb260acb498514d204f34b0f1126))
* canary first run never triggers after duplicate-prevention change ([2e1caeb](https://github.com/velatir/sympozium/commit/2e1caeb2e0fbdf33b07463f059a5e6f90ec2a2ac))
* canary NetworkPolicy, RBAC, provider resolution, and node-probe routing ([5be1db0](https://github.com/velatir/sympozium/commit/5be1db0031bcdf19be09521036740ca5861414de))
* canvas empty state — use controlled ReactFlow props for read-only canvases ([58697be](https://github.com/velatir/sympozium/commit/58697bef2f880488db35c81c82a7a0370fa69f71))
* cascade-delete scheduled AgentRuns when their Schedule is removed ([eb1ad6a](https://github.com/velatir/sympozium/commit/eb1ad6af113686ae5b77c5d3b28c4ba9a913aabb))
* **celln:** remove unused celln-dispatcher-token Secret ([183b8a5](https://github.com/velatir/sympozium/commit/183b8a52b97d507ad48fc93e61a62cef7646c322))
* channelTriggers propagation from Ensembles ([#191](https://github.com/velatir/sympozium/issues/191)) ([9192ae9](https://github.com/velatir/sympozium/commit/9192ae914aa8f3c3b0a211c338b107f546b79c56))
* **ci:** add llmfit-daemon to build and release image matrices ([df3f7e1](https://github.com/velatir/sympozium/commit/df3f7e10c313680b5d9a3b28d8b4edd398edbdda))
* **ci:** disable fail-fast on release image matrix ([50661f8](https://github.com/velatir/sympozium/commit/50661f8a3a07b8a71e5591821e66acd5f7ab6723))
* clear stale baseURL when switching to a cloud provider ([6345d1f](https://github.com/velatir/sympozium/commit/6345d1fe21efac18806c1e84ca70b6f47fb2da62))
* **controller:** honor SYMPOZIUM_IMAGE_TAG for run pods + memory sidecar (ISI-1406/ISI-1417) ([#244](https://github.com/velatir/sympozium/issues/244)) ([604dd57](https://github.com/velatir/sympozium/commit/604dd57dc46c43dd4ec1449dcd670b84d37feaed))
* **controller:** make sequential handoff truncation legible ([bae9701](https://github.com/velatir/sympozium/commit/bae9701bf97cdb55471fdf4706cf73b4def31854))
* **controller:** propagate runTimeout and wire agentEnv into pod spec ([#240](https://github.com/velatir/sympozium/issues/240)) ([d9f584e](https://github.com/velatir/sympozium/commit/d9f584e61f611084fd527389434eb875ab41c70c))
* **controller:** propagate sidecar tools from source SkillPack ([#250](https://github.com/velatir/sympozium/issues/250)) ([46b2cdc](https://github.com/velatir/sympozium/commit/46b2cdcade676d9751eae4391d36603b7018ee69))
* **controller:** reject forged token metrics from agent result markers ([8227556](https://github.com/velatir/sympozium/commit/8227556c3616030c4d25740fb730ef4822d12180))
* **controller:** remove unused triggered var breaking PR [#256](https://github.com/velatir/sympozium/issues/256) build (ISI-1562) ([77ecdb7](https://github.com/velatir/sympozium/commit/77ecdb7e7b5b2c284c62a05d4f44e3f970a7458f))
* **controller:** replace LastRunName check with List to prevent TOCTOU race ([#239](https://github.com/velatir/sympozium/issues/239)) ([a419afe](https://github.com/velatir/sympozium/commit/a419afe7fa898468ba4f11e2033bf7fb32d97a78))
* **controller:** requeue delegation successor when at in-flight cap (PR [#256](https://github.com/velatir/sympozium/issues/256)) ([3aafd0f](https://github.com/velatir/sympozium/commit/3aafd0f56df62990f7c300b7af29e2a5326981e4))
* **controller:** resolve PR [#256](https://github.com/velatir/sympozium/issues/256) maintainer review findings ([7746942](https://github.com/velatir/sympozium/commit/7746942f1a7dc4a208164ef2cba9ec821c31936f))
* correct CHANGELOG header to match actual version 0.10.27 ([3e5ee70](https://github.com/velatir/sympozium/commit/3e5ee70a943459beaf7d81514b068926921fd9b0))
* correct MCP server configs after local testing ([6d56e57](https://github.com/velatir/sympozium/commit/6d56e57d17d23cc5db1505cd90299ed1409f2a84))
* **crd:** accept both string-form and object-form spec.task at admission ([#23](https://github.com/velatir/sympozium/issues/23)) ([0a3d260](https://github.com/velatir/sympozium/commit/0a3d2608a2940bd5a587d3465ff60f8d9732d925))
* **crd:** accept both string-form and object-form spec.task at admission ([#312](https://github.com/velatir/sympozium/issues/312)) ([a29016c](https://github.com/velatir/sympozium/commit/a29016c2d833ac23cc54da33a4e205d32fc3cd77))
* crop gray borders from demo GIF recording ([c300672](https://github.com/velatir/sympozium/commit/c3006725a6b23bba0ca9200e6404324151a11e74))
* default MCP server catalog to disabled (opt-in) ([d164dc0](https://github.com/velatir/sympozium/commit/d164dc01fa7488daf8beac7c7f31d43a839ca5fc))
* derive Celln action IDs from AgentRun name+UID, not name alone ([7d8f85c](https://github.com/velatir/sympozium/commit/7d8f85cf8c2326d431491f0ba684087907e597bc))
* don't hijack canvas zoom/pan keys while typing in inputs ([#221](https://github.com/velatir/sympozium/issues/221)) ([39940e0](https://github.com/velatir/sympozium/commit/39940e0f076794076cb22b9bfad7549c2381e912))
* enforce a controller-side deadline for wedged Celln backends ([d4f46d7](https://github.com/velatir/sympozium/commit/d4f46d7c2cba31e30e265a49b2f64a4073835363))
* enforce sequential ordering in pipeline ensembles ([a86bcc6](https://github.com/velatir/sympozium/commit/a86bcc60b78ae9cedab266b4ed370834786610cd))
* **eventbus:** recover NATS subscriptions after restart/recreate ([#253](https://github.com/velatir/sympozium/issues/253)) ([#254](https://github.com/velatir/sympozium/issues/254)) ([f341b37](https://github.com/velatir/sympozium/commit/f341b372f5a3c1ef69b30a4a7555b048f643e52e))
* **examples:** give the research demo a brief that actually directs research ([de77fda](https://github.com/velatir/sympozium/commit/de77fdad7e00c05b68326831115894185e8cd0ad))
* **fork:** resolve conflict markers in apiserver-deployment.yaml ([e2d13d9](https://github.com/velatir/sympozium/commit/e2d13d9b74488070e0960cfd14a74bba66416a4b))
* **fork:** resolve conflict markers in release.yaml ([710bc5f](https://github.com/velatir/sympozium/commit/710bc5f6e37f18937d2b9a078e71c07bdef8e6d9))
* **fork:** resolve conflict markers in release.yaml ([c7bb506](https://github.com/velatir/sympozium/commit/c7bb506481e9d8b6d2b61736adee1d7226bd4c1d))
* **fork:** resolve remaining conflict markers from upstream sync ([070efc5](https://github.com/velatir/sympozium/commit/070efc5229f9cf6e24930db051eb61bda0fb0fbd))
* generate human-readable random agent names instead of persona-1 ([6c53dd3](https://github.com/velatir/sympozium/commit/6c53dd352a15d67b0f0d156c9da4cc21bad41652))
* gofmt formatting for inference backend files ([8d837bd](https://github.com/velatir/sympozium/commit/8d837bdd332b68cd544c8ef45962237cf5237710))
* guard against unreachable cron expressions in schedule controller ([#220](https://github.com/velatir/sympozium/issues/220)) ([a776f4d](https://github.com/velatir/sympozium/commit/a776f4daa01d380092447cee2a26cb65416f3395))
* heredoc syntax error in ux-test preflight script ([abd0f5d](https://github.com/velatir/sympozium/commit/abd0f5d5cad7eff3e3983b0ec1603b547e6cc8f6))
* hide system canary from ensembles list ([f7c051c](https://github.com/velatir/sympozium/commit/f7c051cf84e607a18bd350b54ec922c34467f824))
* include SympoziumConfig in CLI uninstall resource cleanup ([4d296e4](https://github.com/velatir/sympozium/commit/4d296e4ea46b60c55d06d184ccb2cad0160b65a2))
* infer local model provider from agent model fields ([6393251](https://github.com/velatir/sympozium/commit/6393251ff0d8f48ab65fa3361b4a29bab3607566))
* **install:** disable chart namespace template to avoid collision ([e0aae1c](https://github.com/velatir/sympozium/commit/e0aae1c3a54a95ee6bd5a8d0a2cf1c9c5d9b4b50))
* **install:** make uninstall aware of the bundled llmfit-dra subchart ([92cbef8](https://github.com/velatir/sympozium/commit/92cbef80be3d581db2ac9f20e3f14fec7f72da0d))
* **install:** make uninstall aware of the bundled llmfit-dra subchart ([576b7b6](https://github.com/velatir/sympozium/commit/576b7b6a17839672c51a2044759c4328c9c8ec89))
* **install:** recover from failed releases and simplify ns creation ([4c84612](https://github.com/velatir/sympozium/commit/4c846129d61b99829ef7219c7dc1ed7c4edb6607))
* **install:** vendor the bundled llmfit-dra chart for the embedded installer ([def0522](https://github.com/velatir/sympozium/commit/def0522e3910b7115b319afd328f5a40a67414a1))
* make subagent fanout limits and names reliable ([#247](https://github.com/velatir/sympozium/issues/247)) ([f156807](https://github.com/velatir/sympozium/commit/f15680767c6c403d4f51a924db7bf2e78f4bcc51))
* manually construct Azure OpenAI deployment URL ([58dbcb1](https://github.com/velatir/sympozium/commit/58dbcb1faf83a5e8d978e975013900a441608893))
* manually construct Azure OpenAI deployment URL to work around SDK middleware bug ([ac9cdb5](https://github.com/velatir/sympozium/commit/ac9cdb53ad7276d6631dc68d6ba1782e3d12f129))
* mcp-bridge missing notifications/initialized and sequential discovery ([#197](https://github.com/velatir/sympozium/issues/197)) ([6e5d4a1](https://github.com/velatir/sympozium/commit/6e5d4a16c5cac5022952a7f22f551bfa7e32f8ec)), closes [#194](https://github.com/velatir/sympozium/issues/194)
* model detail page namespace resolution ([894f808](https://github.com/velatir/sympozium/commit/894f808e533d4d2b8f40de5d411815016b506153))
* pass baseURL as wizard default when re-enabling ensemble ([3e8b98d](https://github.com/velatir/sympozium/commit/3e8b98defff3d90801955ebda4707e3bbbcc363b))
* per-persona Discord channel routing and truncated run results ([9407420](https://github.com/velatir/sympozium/commit/9407420c06c64b3289800c83d804a8f62f4acd31))
* per-persona Discord channel routing and truncated run results ([822f9ab](https://github.com/velatir/sympozium/commit/822f9ab02891673e59cbe2b45d2c6d2071d269fd)), closes [#106](https://github.com/velatir/sympozium/issues/106) [#107](https://github.com/velatir/sympozium/issues/107)
* **personas:** harden platform-team prompts + propagate systemPrompt edits ([079986d](https://github.com/velatir/sympozium/commit/079986d5e8edc00cd85cf9ed4d715b36f85a589b))
* preserve ensemble auth config on disable and clean up stale runs ([00ac9e4](https://github.com/velatir/sympozium/commit/00ac9e468bbb15d2f20140337d4b91436e177352))
* preserve namespace for subagent spawning ([#234](https://github.com/velatir/sympozium/issues/234)) ([5c7bd03](https://github.com/velatir/sympozium/commit/5c7bd03bad449bd79f5ca3c412a040f7d333f89d))
* prevent canary agent from looping on empty memory ([23e9088](https://github.com/velatir/sympozium/commit/23e908830326d196bf37ce77802bdbbd2ab8eec3))
* prevent canvas crash when model data hasn't loaded yet ([ddb5410](https://github.com/velatir/sympozium/commit/ddb541073fc81afe65901c58fd7595078ea5b3f2))
* prevent duplicate canary runs on first schedule trigger ([1f5e286](https://github.com/velatir/sympozium/commit/1f5e2864ecc5bd421ddfc0fa73f0533e963c7f55))
* prevent duplicate canary runs on first schedule trigger ([1428d68](https://github.com/velatir/sympozium/commit/1428d68df148a004e60e9e7e47d11902a094fea6))
* prevent panic when AgentRun has nil Labels map ([#170](https://github.com/velatir/sympozium/issues/170)) ([6f0792f](https://github.com/velatir/sympozium/commit/6f0792ff7da72faf76b5f9012337c2d9f35b375c))
* prevent port-forward reconnect loop when port is already bound ([c39199e](https://github.com/velatir/sympozium/commit/c39199eb4d07541f61c88ea018fa50b990b6234e))
* prevent reconcile race from overriding Succeeded AgentRuns as Failed ([d681a33](https://github.com/velatir/sympozium/commit/d681a3359f1d64ec2d8755402c0abe3849d96e8a))
* prevent UI token mismatch after helm upgrade ([32bd78c](https://github.com/velatir/sympozium/commit/32bd78c8532efd0c4fdd1df49b7b432c31e1b928))
* prevent UI token mismatch after helm upgrade ([dac1e87](https://github.com/velatir/sympozium/commit/dac1e8783bcc8fca0122f470b1d3800587bb5e7d)), closes [#113](https://github.com/velatir/sympozium/issues/113)
* propagate Ensemble toolPolicy to AgentRun pods ([67b9161](https://github.com/velatir/sympozium/commit/67b9161e032c409534ade952a6ae05119afacd9a))
* propagate Memory.SystemPrompt to AgentRuns ([#169](https://github.com/velatir/sympozium/issues/169)) ([bc20d3d](https://github.com/velatir/sympozium/commit/bc20d3dbe78ef560218140987c1043f89750ceec))
* propagate skill changes to existing Agents on ensemble update ([2a498c7](https://github.com/velatir/sympozium/commit/2a498c733bf10b5494572e850410b7c1339983b7))
* provider-agnostic API key secret (openaiApiKey, anthropicApiKey, deepseekApiKey) ([1321032](https://github.com/velatir/sympozium/commit/1321032c1f546c487aba14f2ca08ae2f56f10004))
* recover from stuck Terminating namespace during install ([#173](https://github.com/velatir/sympozium/issues/173)) ([30d59a8](https://github.com/velatir/sympozium/commit/30d59a8b9976a542b7cc0e60bf97413f8345d51a))
* reject AgentRuns with both backend=celln and agentSandbox.enabled ([2de81c8](https://github.com/velatir/sympozium/commit/2de81c841eed5a91020cfac9daaf2c5406b81f13))
* **release:** enable Homebrew tap updates ([5aaf821](https://github.com/velatir/sympozium/commit/5aaf821ffdbb5ee3935f2796d2811916e73746e7))
* **release:** enable Homebrew tap updates ([e0a3512](https://github.com/velatir/sympozium/commit/e0a35126c6a52e399fae64b57afa8f5b73d6d0b4))
* remove duplicate YamlButton import in ensemble-detail ([a82a493](https://github.com/velatir/sympozium/commit/a82a4931072bef5f35a088ee26542819d2b8c41a))
* remove finish_reason gate for tool call extraction ([#227](https://github.com/velatir/sympozium/issues/227)) ([14cea32](https://github.com/velatir/sympozium/commit/14cea3235950088450d506d547b741e6f1b9d865))
* remove redundant lock button from topology zoom controls ([2e07dc9](https://github.com/velatir/sympozium/commit/2e07dc9491f8c4086c2113536eee4d41eea32136))
* rename Add Persona→Add Agent, hide GPT models for local model, sort skills ([827f695](https://github.com/velatir/sympozium/commit/827f6953992244abf28e6987ee5cc49c8dda8127))
* rename personas→agentConfigs in default ensemble YAML files ([95c4453](https://github.com/velatir/sympozium/commit/95c445389d60fd623e2548e52daa39a7ba761c94))
* render markdown in feed task messages ([7275510](https://github.com/velatir/sympozium/commit/72755103e0b679330a7576f378cea4a02eb0e22d))
* replace all remaining Instance→Agent in user-facing UI strings ([b3ceb3d](https://github.com/velatir/sympozium/commit/b3ceb3d1ed2b3c22ef21eba32c1c205dfac271a2))
* replace remaining gradient buttons with theme-aware primary and update README demo image ([#203](https://github.com/velatir/sympozium/issues/203)) ([e85c1cf](https://github.com/velatir/sympozium/commit/e85c1cf95747360692650d3b6006d69575e1066b))
* resolve all Cypress TypeScript errors ([008266e](https://github.com/velatir/sympozium/commit/008266efbcec1f39e4929c89c3bf79cb581e3d23))
* resolve Docker build TS errors for provider nodes ([91147fb](https://github.com/velatir/sympozium/commit/91147fbb9dfe589c24aa9dacc64a8270879d4545))
* resolve Docker build TS errors from Instance→Agent rename ([926b5d7](https://github.com/velatir/sympozium/commit/926b5d7c5115d3ced126d2fe6f25be1d5223ddfc))
* resolve flaky Cypress tests for run-delete and run-notifications ([74bab5a](https://github.com/velatir/sympozium/commit/74bab5a59cca869862facb1bd9e62edb9fbbcc71))
* resolve TypeScript errors in ensemble canvas model node types ([b0fa56f](https://github.com/velatir/sympozium/commit/b0fa56f531990e3ceb6f97417538a4443563a543))
* restore version to 0.10.26 after release-please confusion ([aa1ec8b](https://github.com/velatir/sympozium/commit/aa1ec8b24efac88cc7a3cca7455fcdab929b01cc))
* restore version to 0.10.27 after release-please revert ([ee01f90](https://github.com/velatir/sympozium/commit/ee01f90d24a94acf6357821dba56e86af45ce96f))
* restrict WhatsApp channel to self-chat messages only ([3425eb8](https://github.com/velatir/sympozium/commit/3425eb80290f95ce229e91850caef1f1db4e8e6b))
* restrict WhatsApp channel to self-chat messages only ([6af4dca](https://github.com/velatir/sympozium/commit/6af4dcaad6f9e2372e917c4f95e3dd952c706c3e)), closes [#138](https://github.com/velatir/sympozium/issues/138)
* retry Celln router-unreachable errors on a fixed 10s cadence ([eff0d03](https://github.com/velatir/sympozium/commit/eff0d03e0489ec71310750a04d2429e256d76e12))
* router port 8788 (dispatcher uses 8787), TCP probes ([8165c72](https://github.com/velatir/sympozium/commit/8165c7246cb38eb660cf85491718eeb086e0d3b1))
* run make generate for new policy and model types ([2449644](https://github.com/velatir/sympozium/commit/244964411417572c54ca07f7ec2028a73c048842))
* scheduler picks next free run-number suffix to avoid ghost runs ([205829a](https://github.com/velatir/sympozium/commit/205829a2c1525d2b2cf5fbdb09829b254790f601))
* scope TUI resource lists to the active namespace ([#217](https://github.com/velatir/sympozium/issues/217)) ([6479fe5](https://github.com/velatir/sympozium/commit/6479fe5f27714f82da20ced42de6218b21018c4a)), closes [#215](https://github.com/velatir/sympozium/issues/215)
* security hardening for Model, AgentRun, and Ensemble features ([21fc58d](https://github.com/velatir/sympozium/commit/21fc58dc46b3ad0935f184afd90fd5359cd8e5eb))
* **security:** tier-1 hardening for delegation, channels, and API auth ([#265](https://github.com/velatir/sympozium/issues/265)) ([6fd740d](https://github.com/velatir/sympozium/commit/6fd740db84db9a37baffb3dd607fb48b2035e713))
* skip global namespace filter on model API endpoints ([454c872](https://github.com/velatir/sympozium/commit/454c8720d3d3e9140ba75c70fdc5cacaab81fdb5))
* skip Helm CreateNamespace when sympozium-system already exists ([e40b157](https://github.com/velatir/sympozium/commit/e40b157a238de6b91cd8f0e0e18c771eb66e5a0d))
* sort runs list by creation date descending (fixes [#151](https://github.com/velatir/sympozium/issues/151)) ([bed055c](https://github.com/velatir/sympozium/commit/bed055c97af6abdff50edb8e93e2bf14bd164fca))
* stabilize workflow canvas layout across data refreshes ([b83378a](https://github.com/velatir/sympozium/commit/b83378a1ff88c4546781598fc4bd52e65dd22ce9))
* stimulus save, canvas sync, agentrun cleanup, and default MCP servers ([ad6752f](https://github.com/velatir/sympozium/commit/ad6752fa3bad572062aa6c88269f2bb761c5a203))
* surface reasoning-model responses when terminal turn is empty ([045f7d7](https://github.com/velatir/sympozium/commit/045f7d74a2f95b5ebab7eba392c6d4441734368b))
* tighten canary system prompt to prevent command retries ([c226a02](https://github.com/velatir/sympozium/commit/c226a02fa28a71bd81780c005a07eed2fca3c7c3))
* topology page TypeScript build errors ([8a9b712](https://github.com/velatir/sympozium/commit/8a9b712e55827c975e653c9d3f4a3779ea5684af))
* unify canary connection test and fix agent-run NetworkPolicy ([3909012](https://github.com/velatir/sympozium/commit/39090124376dcd2b94a481cfb2e87e8aa6406dd6))
* update all stale Persona Pack UI strings to Ensemble ([12fdaec](https://github.com/velatir/sympozium/commit/12fdaec4c6f73cc9f9febe87bd9d3ed61644f3ed))
* update cypress tests for stimulus relationship in research-team pack ([e21dff9](https://github.com/velatir/sympozium/commit/e21dff97b4a6db335e56dec7db1dd787f8822ef4))
* update expected default Ensemble count from 5 to 6 ([e2aedf3](https://github.com/velatir/sympozium/commit/e2aedf3d5bf23f1ccddf6f9191338ad005d929bb))
* update TUI terminology from Personas/Instances to Ensembles/Agents ([#182](https://github.com/velatir/sympozium/issues/182)) ([7e48fe5](https://github.com/velatir/sympozium/commit/7e48fe578083190c62999b93f4e107c0adf0a334))
* use correct installedPersonas field in ensemble detail page ([b62eea4](https://github.com/velatir/sympozium/commit/b62eea46f38e92d2d052b0a3b3afa7b1d7a0af71))
* use namespace dropdown in model deploy dialog ([e2eef80](https://github.com/velatir/sympozium/commit/e2eef80ef844f4a574c3605c7e6014018b3a4810))
* validate instance name as RFC 1123 subdomain in wizard ([714a405](https://github.com/velatir/sympozium/commit/714a4059ebd356e434bdfe941ed68cf1ca2501e7))
* **web-proxy:** close subscribe-before-find race and skip terminal runs ([71786b7](https://github.com/velatir/sympozium/commit/71786b736dc6ec8ef93c0ecaf31d04f5a2771a45))
* **web-proxy:** close subscribe-before-find race and skip terminal runs ([77c1267](https://github.com/velatir/sympozium/commit/77c12673dad1d21d063418a527c88ae1c85018b7))
* **web-proxy:** dedupe retried chat requests ([bec7af2](https://github.com/velatir/sympozium/commit/bec7af286bd761016659c838af7d1819172bc48b))
* **web-proxy:** dedupe retried chat requests ([d4233f3](https://github.com/velatir/sympozium/commit/d4233f3f4fc7c8153e1b7f2d9737d36c7340b988))
* **web:** make demo topology hardware physically buildable ([eaedf1d](https://github.com/velatir/sympozium/commit/eaedf1d910f03ead6a7d508799b144c2f9dfb87a))
* **web:** prevent gateway toggle from disconnecting UI ([9ededbd](https://github.com/velatir/sympozium/commit/9ededbd830eb7c409e4340a40b222fd1c7651de4))
* **web:** prevent gateway toggle from disconnecting UI ([3ef4772](https://github.com/velatir/sympozium/commit/3ef4772500b15a0149be8c1242ff48154ceb8ee0))
* **web:** repair type errors that broke npm run build ([20ce832](https://github.com/velatir/sympozium/commit/20ce8323dcd9bbb0b2c44d2ce193ef06d25feb04))
* **web:** resolve ReactFlow render loop and Cypress test failures ([#184](https://github.com/velatir/sympozium/issues/184)) ([ad06e12](https://github.com/velatir/sympozium/commit/ad06e12ca7217f06aebd92aa1901d0c6058087a4))
* **web:** stack and group topology accelerator chips ([77f63b3](https://github.com/velatir/sympozium/commit/77f63b3cdc9b32d4bee461a048d0f513912f25f5))
* wire modelRef into ensemble creation and fix persona default model ([85a504a](https://github.com/velatir/sympozium/commit/85a504a2f25da1e999ff58c4d9283a4251db9c2e))
* wiring a local model provider updates agent config panel and node ([05b8f28](https://github.com/velatir/sympozium/commit/05b8f28bc1788536acbc3492d6346e7a5f8c0d25))
