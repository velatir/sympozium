...
func TestBuildJob_BasicMetadata(t *testing.T) {
	...
	run := newTestRun()
	job := r.buildJob(run, false, nil, nil, nil, nil, nil)
...
func TestBuildJob_TTLAndBackoff(t *testing.T) {
	r := &AgentRunReconciler{}
	job := r.buildJob(newTestRun(), false, nil, nil, nil, nil, nil)
...
func TestBuildContainers_BasicCount(t *testing.T) {
	r := &AgentRunReconciler{}
	cs, _ := r.buildContainers(newTestRun(), false, nil, nil, nil, nil, nil)
	// agent + ipc-bridge = 2
	if len(cs) != 2 {
...
func TestBuildContainers_MemoryMount(t *testing.T) {
	r := &AgentRunReconciler{}
	run := newTestRun()
	cs, _ := r.buildContainers(run, true, nil, nil, nil, nil, nil)
...
func TestBuildContainers_SkillSidecarInjected(t *testing.T) {
	...
	cs, _ := r.buildContainers(newTestRun(), false, nil, sidecars, nil, nil, nil)
...
func TestBuildJob_WithSkillSidecars(t *testing.T) {
	...
	job := r.buildJob(newTestRun(), false, nil, sidecars, nil, nil, nil)
...
func TestBuildContainers_ObservabilityEnv(t *testing.T) {
	...
	cs, _ := r.buildContainers(run, false, obs, nil, nil, nil, nil)
...
func TestBuildContainers_PreRunInitContainers(t *testing.T) {
	...
	containers, initContainers := r.buildContainers(run, false, nil, nil, nil, nil, nil)
...
func TestBuildContainers_PreRunVolumeMounts(t *testing.T) {
	...
	_, initContainers := r.buildContainers(run, false, nil, nil, nil, nil, nil)
...
func TestBuildContainers_PreRunAppearsAfterSystemInits(t *testing.T) {
	...
	_, initContainers := r.buildContainers(run, true, nil, nil, nil, nil, nil)
